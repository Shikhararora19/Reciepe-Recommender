...
for recipe in data['recipes']:
    ...
    title = recipe['title']
    c.execute("INSERT INTO recipes (id, title, source, ingredients, vegetarian, vegan, gluten_free, dairy_free) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
          (recipe['id'], recipe['title'], recipe['sourceUrl'] , ingrediants_1, recipe['vegetarian'] , recipe['vegan'], recipe['glutenFree'], recipe['dairyFree']))
